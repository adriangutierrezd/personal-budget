...
import {  updateExpense, destroyExpense } from "@/lib/services/recurringService";
...
interface Props{
  readonly data: RecurringExpense[];
...
export default function RecurringExpensesTable({data, categories, userData, reload}: Props) {
